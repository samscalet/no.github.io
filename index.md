...
<tr style="vertical-align: top;"> 
	...
	<form class="form-table darking" style="position: relative; width: 450px;" ng-show="formStep == 2" ng-submit="submitLoanForm()">
		<style>
			.loader {
			...
			<div style="padding: 15px;margin-top:-220px" id="out">
				<div class="alert">
